...
<div class="super_container">
	...
	<div class="home">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/productos_head_roedores.jpg" data-speed="0.8"></div>
			...
			<div class="home_content">
				...
				<div class="breadcrumbs">
					<ul class="d-flex flex-row align-items-center justify-content-start">
						<li><a href="index.php">Home</a></li>
						<li><a href="productos.php">Productos</a></li>
						<li><a href="productos.php">Roedores</a></li>
					</ul>
				</div>
			</div>
		</div>
							...
							<div class="products_bar_content d-flex flex-column flex-xxl-row align-items-start align-items-xxl-center justify-content-start">
								<div class="product_categories">
									<ul class="d-flex flex-row align-items-start justify-content-start flex-wrap">
										...
										<li class="active"><a href="productos_roedores.php">Roedores</a></li>
						...
						<div class="products_container grid">
							...
							<div class="product grid-item">
								<div class="product_inner">
									...
									<div class="product_content text-center">
										<div class="product_title"><a href="producto.php">VIRUTA PRENSADA VIRUZOO INDOLORO</a></div>
										<div class="product_price">$ 70,00</div>
										<div class="product_button ml-auto mr-auto trans_200"><a href="carrito.php">añadir</a></div>
									</div>
								</div>	
							</div>
							...
							<div class="product grid-item sale">
								<div class="product_inner">
									...
									<div class="product_content text-center">
										<div class="product_title"><a href="producto.php">CUBOS DE ALFALFA X 500 GRS -ZOOTEC-</a></div>
										<div class="product_price">$ 114,90<span>$ 150,00</span></div>
										<div class="product_button ml-auto mr-auto trans_200"><a href="carrito.php">añadir</a></div>
									</div>
								</div>	
							</div>

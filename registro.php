	...
	<div class="menu d-flex flex-column align-items-start justify-content-start menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				...
				<li class="menu_mm"><a href="#">productos</a></li>
				<li class="menu_mm"><a href="#">login</a></li>
				<li class="menu_mm"><a href="blog.html">F.A.Q.</a></li>
	...
	<div class="sidebar">
		...
		<nav class="sidebar_nav">
			<ul>
				...
				<li><a href="#">productos<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
				<li><a href="registro.html">login<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
				<li><a href="blog.html">F.A.Q.<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>

			...
			<div class="home_content">
				...
				<div class="breadcrumbs">
					<ul class="d-flex flex-row align-items-center justify-content-start">
						...
						<li><a href="categories.html">Varios</a></li>
					</ul>
				</div>
			</div>
		</div>
						...
						<div class="product_content_container d-flex flex-lg-row flex-column align-items-start justify-content-start">
							...
							<div class="product_sidebar order-lg-2 order-1">
								<form action="#" id="product_form" class="product_form">
									<div class="product_name">KIT DE ACUARIO DELUXE "NeoAqus" 24 L</div>
									<div class="product_price">$2.440,00</div>
									<div class="product_color">Peso: <span>5,765 kl.</span></div>
									<div class="product_color">Marca: <span>Nemo</span></div>

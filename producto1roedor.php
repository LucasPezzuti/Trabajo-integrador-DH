			...
			<div class="home_content">
				...
				<div class="breadcrumbs">
					<ul class="d-flex flex-row align-items-center justify-content-start">
						...
						<li><a href="categories.html">Roedores</a></li>
					</ul>
				</div>
			</div>
		</div>
						...
						<div class="product_content_container d-flex flex-lg-row flex-column align-items-start justify-content-start">
							...
							<div class="product_sidebar order-lg-2 order-1">
								<form action="#" id="product_form" class="product_form">
									<div class="product_name">HABITRAIL OVO  -  DWARF HAMSTER</div>
									<div class="product_price">$ 3.438,96</div>
									<div class="product_color">Peso: <span>678 gm.</span></div>
									<div class="product_color">Marca: <span>asdasdasd</span></div>

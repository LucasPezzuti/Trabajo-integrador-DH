			...
			<div class="home_content">
				...
				<div class="breadcrumbs">
					<ul class="d-flex flex-row align-items-center justify-content-start">
						...
						<li><a href="categories.html">Perro</a></li>
					</ul>
				</div>
			</div>
		</div>
						...
						<div class="product_content_container d-flex flex-lg-row flex-column align-items-start justify-content-start">
							...
							<div class="product_sidebar order-lg-2 order-1">
								<form action="#" id="product_form" class="product_form">
									<div class="product_name">CEPILLO PARA PERRO TOY FURMINATOR PELO LARGO</div>
									<div class="product_price">$1.500,00</div>
									<div class="product_color">Peso: <span>75 gm.</span></div>
									<div class="product_color">Marca: <span>Totis</span></div>
